...
constexpr float ENCODER_RESOLUTION_A         = 92500.0f;
constexpr float MOTOR_GEAR_RATIO_A           = 138.6f;
constexpr float ENCODER_RESOLUTION_B         = 10000.0f;
constexpr float MOTOR_GEAR_RATIO_B           = 45.5f;
...
struct NodeControl {
    ...
    NodeControl(uint8_t node_id, MotorType type) 
        ...
        if (motor_type == STEERING_MOTOR) {
            encoder_resolution = ENCODER_RESOLUTION_A;
            gear_ratio = MOTOR_GEAR_RATIO_A;
        } else {
            encoder_resolution = ENCODER_RESOLUTION_B;
            gear_ratio = MOTOR_GEAR_RATIO_B;
        }
